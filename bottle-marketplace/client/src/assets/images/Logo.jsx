...
export const LogoIcon = ({ className = "w-6 h-6" }) => (
  ...
  >
    ...
    <path
      ...
      className="fill-lexa-600 dark:fill-lexa-400"
    />
    {/* Bottle Cap */}
    <path d="M10 2H14V4H10V2Z" className="fill-lexa-700 dark:fill-lexa-500" />
    {/* Liquid Level */}
    <path
      ...
      className="fill-lexa-400 dark:fill-lexa-300"
    />
  </svg>
);
  ...
  return (
    <div className={`flex items-center ${className}`}>
      ...
      <div className="flex flex-col">
        ...
        <span className="text-sm text-gray-700 dark:text-gray-300 tracking-wider font-medium">
          PREMIUM BOTTLES
        </span>
      </div>
    </div>
